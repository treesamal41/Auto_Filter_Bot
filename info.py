...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001774819881'))  # Log channel id (make sure bot is admin)
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002134939744')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003115617407")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002134939744")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://files.catbox.moe/9zhwqp.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'amaljoy8848-1@okicici')    # Owner UPI ID for payments
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+Y2LXlbSQAGkwZTNl') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/soulsharper') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+TBrZ6ZXEC4tjZWVl') # Update channel link for the bot
